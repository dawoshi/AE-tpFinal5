...
//      public int TAMANOPARETO=2; //para un contexto de maximizacion      
//-----------------------------------------
    public Pareto2(int contexto){
...
*/        
    ...
    */
    public Individuo [] getConjuntoPareto(Individuo [] listadoObjetivos){
        //----------------------------------------------------------------------
        Vector <Individuo> conjuntoPareto=new Vector<Individuo>();
...
//                        System.out.println(" IGUALES, NO HACE NADA");
  ...
  //                          listadoObjetivos[i].mostrarSoluciones();
    ...
    //                    System.out.println("u NO DOMINA a v en MINIMIZACION ->"+"v="+v[0]+","+v[1]);
        ...
        return conjuntoPareto.toArray(new Individuo[conjuntoPareto.size()]);
        //----------------------------------------------------------------------
    }//getConjuntoPareto
